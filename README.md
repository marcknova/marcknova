...
🖥️ Frontend Developer with 3+ years of experience building web and mobile applications — from CMS-driven platforms and REST API automation to React Native apps in production.

🚀 Currently expanding into full-stack with **React 19 + TypeScript + Java/Spring Boot**.
...
![JavaScript](https://img.shields.io/badge/javascript-%23FFEB3B.svg?style=for-the-badge&logo=javascript&logoColor=black)
![TypeScript](https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white)
